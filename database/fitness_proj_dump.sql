...
INSERT INTO `meal` VALUES (1,'Banana oatmeal (1 cup oats) w/ low-fat milk (1 cup)',490,97,7,19),(2,'Tofu scramble',385,10,29,28),(3,'Egg-white omelet (4 egg whites, 1 whole egg) with spinach (1 cup) and oyster mushrooms (½ cup)',235,5,26,12),(4,'Avocado tuna salad',472,19,36,31),(5,'Chicken broccoli casserole',492,39,22,37),(6,'Chicken caprese sandwich',275,8,34,11);
